...
public:
	Thread(int (*entry)(), const State & state = READY,
			const Criterion & criterion = NORMAL, unsigned int stack_size =
					STACK_SIZE);
	...
	Thread(int (*entry)(T1 a1, T2 a2), T1 a1, T2 a2,
			const State & state = READY, const Criterion & criterion = NORMAL,
	...
	Thread(const Task & task, int (*entry)(), const State & state = READY,
			const Criterion & criterion = NORMAL, unsigned int stack_size =
					STACK_SIZE);
	template<typename T1>
	Thread(const Task & task, int (*entry)(T1 a1), T1 a1, const State & state =
			READY, const Criterion & criterion = NORMAL,
			unsigned int stack_size = STACK_SIZE);
	template<typename T1, typename T2>
	Thread(const Task & task, int (*entry)(T1 a1, T2 a2), T1 a1, T2 a2,
			...
			unsigned int stack_size = STACK_SIZE);
	template<typename T1, typename T2, typename T3>
	Thread(const Task & task, int (*entry)(T1 a1, T2 a2, T3 a3), T1 a1, T2 a2,
			T3 a3, const State & state = READY, const Criterion & criterion =
					NORMAL, unsigned int stack_size = STACK_SIZE);
	template<typename T1, typename T2, typename T3, typename T4>
	Thread(const Task & task, int (*entry)(T1 a1, T2 a2, T3 a3, T4 a4), T1 a1,
			T2 a2, T3 a3, T4 a4, const State & state = READY,
			const Criterion & criterion = NORMAL, unsigned int stack_size =
					STACK_SIZE);
...
inline Thread::Thread(int (*entry)(), const State & state,
		const Criterion & criterion, unsigned int stack_size) :
		_task(multitask ? Task::self() : 0), _state(state), _waiting(0), _joining(
				0), _link(this, criterion) {
	lock();
...
template<typename T1>
inline Thread::Thread(int (*entry)(T1 a1), T1 a1, const State & state,
		const Criterion & criterion, unsigned int stack_size) :
		_task(multitask ? Task::self() : 0), _state(state), _waiting(0), _joining(
				0), _link(this, criterion) {
	lock();
...
inline Thread::Thread(int (*entry)(T1 a1, T2 a2), T1 a1, T2 a2,
		const State & state, const Criterion & criterion,
...
template<typename T1, typename T2, typename T3, typename T4>
inline Thread::Thread(int (*entry)(T1 a1, T2 a2, T3 a3, T4 a4), T1 a1, T2 a2,
		T3 a3, T4 a4, const State & state, const Criterion & criterion,
		unsigned int stack_size) :
		_task(multitask ? Task::self() : 0), _state(state), _waiting(0), _joining(
				0), _link(this, criterion) {
	lock();
...
inline Thread::Thread(const Task & task, int (*entry)(), const State & state,
		const Criterion & criterion, unsigned int stack_size) :
		_task(&task), _state(state), _waiting(0), _joining(0), _link(this,
				criterion) {
	lock();
...
template<typename T1, typename T2>
inline Thread::Thread(const Task & task, int (*entry)(T1 a1, T2 a2), T1 a1,
		T2 a2, const State & state, const Criterion & criterion,
		unsigned int stack_size) :
		_task(&task), _state(state), _waiting(0), _joining(0), _link(this,
				criterion) {
	lock();
...
template<typename T1, typename T2, typename T3>
inline Thread::Thread(const Task & task, int (*entry)(T1 a1, T2 a2, T3 a3),
		T1 a1, T2 a2, T3 a3, const State & state, const Criterion & criterion,
		unsigned int stack_size) :
		_task(&task), _state(state), _waiting(0), _joining(0), _link(this,
				criterion) {
	lock();
...
template<typename T1, typename T2, typename T3, typename T4>
inline Thread::Thread(const Task & task,
